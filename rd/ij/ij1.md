...
Shortcut|说明
---|---
Control + Space|基本的代码补全（补全任何类、方法、变量）(Conflict with Mac shortcuts)
Control + Shift + Space|智能代码补全（过滤器方法列表和变量的预期类型）(Conflict with Mac shortcuts)
...
Control + Enter, Control + N|生成代码（getter、setter、hashCode、equals、toString、构造函数等）
Command + O|覆盖方法（重写父类方法）
Command + I|实现方法（实现接口中的方法）
Command + Option + T|包围代码（使用if...else、try...catch、for、synchronized等包围选中的代码）
Command + /|注释 / 取消注释与行注释
Control + Shift + /|注释 / 取消注释与块注释
Control + Shift + Q|显示上下文信息
Option + Enter|显示意向动作和快速修复代码
Command + Option + L|格式化代码(Conflict with Mac shortcuts)
...
Shortcut|说明
---|---
Option + F7 / Command + F7|在文件中查找引用 / 在类中查找引用
Command + Shift + F7|在文件中突出显示的引用
Command + Option + F7|显示引用
